...
![main](https://seanluis.github.io/eip-draft/images/diagrams/main.svg)
...
![risk-thresholds](https://seanluis.github.io/eip-draft/images/diagrams/risk-thresholds.svg)
...
![threshold-levels](https://seanluis.github.io/eip-draft/images/diagrams/threshold-levels.svg)
...
![oracle-integration](https://seanluis.github.io/eip-draft/images/diagrams/oracle-integration.svg)
...
For more details please visit: [Solvency Proof Implementation](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/contracts/SolvencyProof/SolvencyProof.sol)
...
[SolvencyProof.sol](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/contracts/SolvencyProof/SolvencyProof.sol) provides a complete implementation of the `ISolvencyProof` interface with:
...
This implementation is under license: [MIT](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/LICENSE.md)

### Test Suite

[SolvencyProof.test.ts](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/tests/SolvencyProof.test.ts) contains an extensive test suite that:
...
For more information please visit: [Test Case Documentation](https://seanluis.github.io/eip-draft/docs/full-test-case)
...
**Security Documentation:** We've documented our security approach thoroughly. Check out the [Security Validation Report](https://seanluis.github.io/eip-draft/docs/security-validation-report) for detailed parameter validation and the [Fork Testing Guide](https://seanluis.github.io/eip-draft/docs/fork-testing-guide) for mainnet validation instructions.

**Test Coverage:** Our test suite includes 23 tests total—13 for core ERC functionality ([SolvencyProof.test.ts](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/tests/SolvencyProof.test.ts)) and 10 focused on security features ([SecurityFeatures.test.ts](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/tests/SecurityFeatures.test.ts)). Every security-critical code path is tested.

**Testing Approach:** The [MaliciousOracle.sol](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/contracts/test/MaliciousOracle.sol) and [MockMultiOracle.sol](https://github.com/SeanLuis/eip-draft/blob/main/assets/erc-7893/contracts/test/MockMultiOracle.sol) contracts simulate attack scenarios and consensus mechanisms for testing purposes. They do not connect to real oracle networks but provide comprehensive coverage of potential attack vectors and edge cases that protocols implementing this ERC should be prepared to handle.

## Copyright

Copyright and related rights waived via [CC0](https://github.com/SeanLuis/eip-draft/blob/main/LICENSE.md).
